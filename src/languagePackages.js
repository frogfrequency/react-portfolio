export const languagePackages = {
    english: {
        ...
        titles: {
            ...
            literatureSubheader: `books I'm currently reading or already have read`,
        },
        colorSchemePage: {
            addScheme: 'add new scheme',
            adjustColorsFor: 'adjust colors for:',
    ...
    german: {
        ...
        titles: {
            ...
            literatureSubheader: `Bücher die ich momentan lese oder bereits gelesen habe`,
        },
        colorSchemePage: {
